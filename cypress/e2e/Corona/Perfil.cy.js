...
describe('PERFIL BRASIL', () => {
    ...
    describe('login/log out', () => {
        it('A ferramenta deve realizar o login e logo depois realizar log out', () => {
            ...
            cy.request({
                method: 'POST',
                url: 'https://coronacom.test-abinbev.acsitefactory.com/pt-br/sunsets23/user/sso/entrar', // baseUrl is prepend to URL
            ...
            cy.get('.coh-ce-cpt_header_hamburger_button_fwc-e6b7b2b3 > .profile-header-link > .ssa-component > .coh-ce-cpt_button-a384e411 > .paragraph-container-horizontal-none > .coh-container > .coh-link').click({ force: true })
            cy.get('.has-logout > .coh-link').click({ force: true })
        })
    })
})